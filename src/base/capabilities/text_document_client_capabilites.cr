...
struct LSP::TextDocumentClientCapabilities
  ...
  struct CompletionClientCapabilities
    ...
    struct CompletionItem
      ...
      struct TagSupport
        ...
        @[JSON::Field(key: "valueSet", converter: JSON::ArrayConverter(Enum::ValueConverter(LSP::CompletionItemTag)))]
    ...
    struct CompletionItemKindValue
      ...
      @[JSON::Field(key: "valueSet", converter: JSON::ArrayConverter(Enum::ValueConverter(LSP::CompletionItemKind)))]
  ...
  struct PublishDiagnosticsClientCapabilities
    ...
    struct TagSupportValue
      ...
      @[JSON::Field(key: "valueSet", converter: JSON::ArrayConverter(Enum::ValueConverter(LSP::DiagnosticTag)))]
